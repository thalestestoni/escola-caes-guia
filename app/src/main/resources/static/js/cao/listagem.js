                ...
                return `
                    <tr id="cao-item-list">
                        ...
                        <td class="col-md-2 text-center">
                            <a class="icon-link icon-link-hover" href="${urlCao}/visualizar" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);">
                            ...
                            <a class="icon-link icon-link-hover ms-3" href="${urlCao}/deletar" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);">
